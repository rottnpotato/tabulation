    ...
    <div class="space-y-4 sm:space-y-6">
      ...
      <div class="flex justify-end space-x-4 mt-8">
        ...
        <button
          ...
          class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-teal-600 border border-teal-700 rounded-md shadow-sm hover:bg-teal-700 transition-colors duration-150 ease-in-out cursor-pointer"
        >
